...
describe("User register authentication", () => {
  ...
  it.only("User can register", async () => {
    ...
    await waitFor(() => {
      render(<QueryClientProvider client={queryClient}><Router><RootLayout /></Router></QueryClientProvider>)
      const title = screen.getByText(/Welcome to the Orchard Self Serve Demo/)
